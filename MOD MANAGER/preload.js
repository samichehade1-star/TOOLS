...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  // trainer / spoofer / pak bypass / unlocker: launch whatever exe is sitting
  // in the user-configured folder for that tool
  launchTrainer: () => ipcRenderer.invoke('launch-trainer'),
  launchSpoofer: () => ipcRenderer.invoke('launch-spoofer'),
  launchPakBypass: () => ipcRenderer.invoke('launch-pakbypass'),
  launchUnlocker: () => ipcRenderer.invoke('launch-unlocker'),
